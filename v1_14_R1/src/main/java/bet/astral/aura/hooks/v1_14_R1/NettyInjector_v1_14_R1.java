...
public class NettyInjector_v1_14_R1 implements AuraNettyInjector {
	@Override
	...
	@Override
	public NettyHandler_v1_14_R1 createInjector(Player player, AuraUserProvider provider) {
		return new NettyHandler_v1_14_R1(player, provider);
	}
}
