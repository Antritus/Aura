...
public final class NettyHandler_v1_20_R1 extends ChannelDuplexHandler implements AuraNettyHandler {
	...
	public NettyHandler_v1_20_R1(Player viewer, AuraUserProvider users) {
		this.viewer = viewer;
		this.users = users;
	}
