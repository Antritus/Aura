...
@Version(
	internalVersion = "v1_18_R1",
	legacyVersion = "v1_18_R1",
	maximumVersion = "1.18.1",
	miniumVersion = "1.18",
	legacy = true
)
public class VersionHandler_v1_18_R1 implements VersionHandler {
	private AuraInternal aura;
	private AuraNettyInjector injector;
	@Override
	public void initialize() {
		aura = new Aura_v1_18_R1();
		injector = new NettyInjector_v1_18_R1();
	}
