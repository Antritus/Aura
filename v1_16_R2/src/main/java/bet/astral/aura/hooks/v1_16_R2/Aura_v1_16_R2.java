...
public class Aura_v1_16_R2 implements AuraInternal {
	private static Logger log = Logger.getLogger(Aura_v1_16_R2.class.getName());
	...
	public void setGlowPacket(Player player, Entity entity) {
		...
		byte oldFlags = dataWatcher.get(NettyHandler_v1_16_R2.FLAGS);
		byte newFlags = (byte) (oldFlags | 0x40);

		DataWatcher watcher = createWatcher(dataWatcher);
		watcher.register(NettyHandler_v1_16_R2.FLAGS, newFlags);
	...
	public void unsetGlowPacket(Player player, Entity entity) {
		...
		DataWatcher watcher =  createWatcher(dataWatcher);
		dataWatcher.register(NettyHandler_v1_16_R2.FLAGS, newFlags);
