...
public final class NettyHandler_v1_10_R1 extends ChannelDuplexHandler implements AuraNettyHandler {
	...
	public NettyHandler_v1_10_R1(Player viewer, AuraUserProvider users) {
		this.viewer = viewer;
		this.users = users;
	}
	...
	private void handleMetadata(
		...
		DataWatcher data = Aura_v1_10_R1.createWatcher(packet);
		if (!found) {
