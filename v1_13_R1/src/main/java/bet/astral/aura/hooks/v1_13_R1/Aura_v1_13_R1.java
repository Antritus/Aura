package bet.astral.aura.hooks.v1_13_R1;
...
public class Aura_v1_13_R1 implements AuraInternal {
	private static Logger log = Logger.getLogger(Aura_v1_13_R1.class.getName());
	...
	public void setGlowPacket(Player player, Entity entity) {
		...
		byte oldFlags = dataWatcher.get(NettyHandler_v1_13_R1.FLAGS);
		byte newFlags = (byte) (oldFlags | 0x40);

		DataWatcher watcher = createWatcher(dataWatcher);
		watcher.register(NettyHandler_v1_13_R1.FLAGS, newFlags);
	...
	public void unsetGlowPacket(Player player, Entity entity) {
		...
		DataWatcher watcher =  createWatcher(dataWatcher);
		dataWatcher.register(NettyHandler_v1_13_R1.FLAGS, newFlags);
