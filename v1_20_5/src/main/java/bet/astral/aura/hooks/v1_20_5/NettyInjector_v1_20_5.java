package bet.astral.aura.hooks.v1_20_5;
...
public class NettyInjector_v1_20_5 implements AuraNettyInjector {
	@Override
	...
	@Override
	public NettyHandler_v1_20_5 createInjector(Player player, AuraUserProvider provider) {
		return new NettyHandler_v1_20_5(player, provider);
	}
}
