...
public final class NettyHandler_v1_16_R3 extends ChannelDuplexHandler implements AuraNettyHandler {
	...
	public NettyHandler_v1_16_R3(Player viewer, AuraUserProvider users) {
		this.viewer = viewer;
		this.users = users;
	}
	...
	private void handleMetadata(
		...
		DataWatcher data = Aura_v1_16_R3.createWatcher(packet);
		if (!found) {
