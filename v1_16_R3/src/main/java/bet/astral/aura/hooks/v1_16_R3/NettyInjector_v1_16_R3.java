...
public class NettyInjector_v1_16_R3 implements AuraNettyInjector {
	@Override
	...
	@Override
	public NettyHandler_v1_16_R3 createInjector(Player player, AuraUserProvider provider) {
		return new NettyHandler_v1_16_R3(player, provider);
	}
}
