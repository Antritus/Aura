...
public class NettyInjector_v26_1_R1 implements AuraNettyInjector {
	@Override
	...
	@Override
	public NettyHandler_v26_1_R1 createInjector(Player player, AuraUserProvider provider) {
		return new NettyHandler_v26_1_R1(player, provider);
	}
}
