...
public class NettyInjector_v1_9_R2 implements AuraNettyInjector {
	@Override
	...
	@Override
	public NettyHandler_v1_9_R2 createInjector(Player player, AuraUserProvider provider) {
		return new NettyHandler_v1_9_R2(player, provider);
	}
}
