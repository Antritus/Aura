...
public class NettyInjector_v1_20_R4 implements AuraNettyInjector {
	@Override
	...
	@Override
	public NettyHandler_v1_20_R4 createInjector(Player player, AuraUserProvider provider) {
		return new NettyHandler_v1_20_R4(player, provider);
	}
}
