...
public class NettyInjector_v1_21 implements AuraNettyInjector {
	@Override
	...
	@Override
	public NettyHandler_v1_21 createInjector(Player player, AuraUserProvider provider) {
		return new NettyHandler_v1_21(player, provider);
	}
}
