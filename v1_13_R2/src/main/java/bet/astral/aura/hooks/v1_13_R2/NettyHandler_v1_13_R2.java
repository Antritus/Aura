...
public final class NettyHandler_v1_13_R2 extends ChannelDuplexHandler implements AuraNettyHandler {
	...
	public NettyHandler_v1_13_R2(Player viewer, AuraUserProvider users) {
		this.viewer = viewer;
		this.users = users;
	}
	...
	private void handleMetadata(
		...
		DataWatcher data = Aura_v1_13_R2.createWatcher(packet);
		if (!found) {
